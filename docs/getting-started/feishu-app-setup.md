...
- Replies to a bot's interactive answer card are supported as well. MetaBot extracts visible Markdown, text, and table content from card schemas v1 and v2 while excluding footer metadata and interactive control values.
